...
# This file was copied from openstack SDK. We added the updated_at attribute
...
class Volume(resource.Resource):
    ...
    # Openstack Train does not yet allow for filtering by updated_at
    _query_mapping = resource.QueryParameters(
        'name', 'status', 'project_id', 'updated_at', all_projects='all_tenants')
